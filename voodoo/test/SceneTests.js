 ...
 * @constructor
 */
var SceneTests = TestCase('SceneTests');
...
/**
 * Tests that the localToPage and pageToLocal functions work.
 */
SceneTests.prototype.testConvertCoordinates = function() {
  /*:DOC +=
    <div style="position:absolute; left:400px; top:400px;
        width:200px; height:200px;" id="anchor">
      <p>anchor</p>
  ...
  */
  ...
  var CustomModel = voodoo.Model.extend({
    ...
    testCoordinates: function() {
      var page = this.view.localToPage([0.5, -0.5, 100]);

      assertEquals('Page X', 600, page[0]);
      assertEquals('Page Y', 400, page[1]);
